    ...
    <Layout>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50"><tr>{['Subject', 'Code', 'Class'].map(h => <th key={h} className="text-left px-4 py-3 text-sm font-semibold text-gray-600">{h}</th>)}</tr></thead>
          <tbody className="divide-y divide-gray-100">
            ...
            {assignments.length === 0 && <tr><td colSpan={3} className="px-4 py-8 text-center text-gray-400">No assignments yet</td></tr>}
          </tbody>
        </table>
      </div>
    </Layout>
