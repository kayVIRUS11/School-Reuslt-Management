...
const EMPTY_FORM = { staff_id_number: '', first_name: '', last_name: '', password: '' };
...
export default function StaffPage() {
  ...
  const openEdit = (s) => { setEditing(s); setForm({ staff_id_number: s.staff_id_number, first_name: s.first_name, last_name: s.last_name, password: '' }); setModal(true); };
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {editing && (
            <div>
              ...
              <input type="password" value={form.password} onChange={e => setForm({...form, password: e.target.value})} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
            </div>
          )}
